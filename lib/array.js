...
internals.Array.prototype.unique = function (customComparator) {
    ...
    return this._test('unique', undefined, (value, state, options) => {
        ...
        const defaultComparator = Hoek.deepEqual;
        const isEqual = typeof customComparator === 'function' ? function (a, b) {

            return customComparator.call(null, a, b, defaultComparator);
        } : defaultComparator;
