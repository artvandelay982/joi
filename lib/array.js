...
internals.Array.prototype.unique = function (deepEqualComparator) {
    ...
    return this._test('unique', undefined, (value, state, options) => {
        ...
        const deepEqual = typeof deepEqualComparator === 'function' ? deepEqualComparator : Hoek.deepEqual;
